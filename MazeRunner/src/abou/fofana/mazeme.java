...
public class mazeme {
	...
	public static void main(String[] args) {
		...
		//char[][] previous_maze = new char[r][c];   //finding a way to store previous maze for re-scanning 
		while(ans){
	 ...
	 */
	private static boolean solveMazeEG(int row, int col, char[][]m) {
	 ...
	 * @return
	 */
	private static boolean solveMazeAG(int row, int col, char[][]m) {
	 ...
	 * @return
	 */
	private static boolean solveMazeFG(int row, int col, char[][]m) {
